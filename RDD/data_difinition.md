...
| **Tags（タグ）**           | 商品に設定するタグ情報 |
| **Products_tags（商品タグ）**| 各商品とそれに紐づくタグ情報 |
...
#### 7. **Product_Comments (コメント)**
- ユーザーが商品に対して投稿したコメントを管理します。評価（星の数）やコメント内容などが含まれます。

| 属性名             | データ型        | 説明                                             |
|-------------------|-----------------|--------------------------------------------------|
| `comment_id`      | INT (PK)        | コメントID（ユニーク識別子）                             |
...
#### 8. **Currency_Transactions (通貨取引)**
- ユーザーが行った通貨取引の履歴を管理します。取引の種類（通貨購入、ダウンロードなど）、取引額などを記録します。

| 属性名             | データ型        | 説明                                           |
|-------------------|-----------------|----------------------------------------------|
| `curr_trans_id`   | INT (PK)        | 取引ID（ユニーク識別子）                             |
